...
import NumberInput from "../../../../components/package/number-input/Preview.vue";

const error = ref('')

const fillValue = ref(undefined)
...
<template>
  ...
  <div class="doc-item doc-item-one">
    <NumberInput v-model:model-value="fillValue"/>
  </div>
  ...
  <div class="doc-item doc-item-one">
    <NumberInput v-model:model-value="fillValue" @blur="(val:string)=>setError(val)"/>
  </div>
  <div class="doc-item">
    <div class="doc-table">
